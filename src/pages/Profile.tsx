        ...
        <Card className='card-friendly lg:col-span-1'>
          <CardHeader className='text-center'>
            <div className='mx-auto mb-4'>
              <div
                className={`w-24 h-24 ${currentRoleConfig.color} rounded-full flex items-center justify-center`}
              >
          ...
          <CardContent className='space-y-6'>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              <div className='space-y-2'>
                ...
                {isEditing ? (
                  ...
                  <p className='text-sm font-medium p-2 bg-secondary/30 rounded-md'>
                    {formData.name}
                  </p>
                )}
              </div>
            ...
            <div className='space-y-2'>
              ...
              {isEditing ? (
                ...
                <p className='text-sm p-2 bg-secondary/30 rounded-md'>
                  {formData.bio}
                </p>
              )}
            </div>
